...
<h1 style="font-size:30px; text-align: center;">This Month</h1>
<div class="display-boxes">
    <div class="boxes" style="background-color:darkred;color:white;">
        <h3>Total Expense</h3>
        <p class="cost"><?php echo "$total_all" ?></p>
    </div>
    <div class="boxes" style="background-color:green;color:white;">
        <h3>Total Savings</h3>
        <p class="cost"><?php echo "$total_savings" ?></p>
    </div>
    <div class="boxes" style="background-color:brown;color:white;">
        <h3>Travel Fuel</h3>
        <p class="cost"><?php echo "$total_fuel" ?></p>
    </div>
    <div class="boxes" style="background-color:#118169;color:white;">
        <h3>Food</h3>
        <p class="cost"><?php echo "$total_food" ?></p>
    </div>
    <div class="boxes" style="background-color:darkblue;color:white;">
        <h3>Investment</h3>
        <p class="cost"><?php echo "$total_investment" ?></p>
    </div>
    <div class="boxes" style="background-color:purple;color:white;">
        <h3>Lifestyle</h3>
        <p class="cost"><?php echo "$total_lifestyle" ?></p>
    </div>
</div>

<h2 style="font-size:24px; text-align: center;">Recent Expenses</h2>
<div style="overflow-x:auto;">
    <table>
        ...
        <?php
            $sql_recent = "SELECT * FROM expense ORDER BY id DESC LIMIT 5";
